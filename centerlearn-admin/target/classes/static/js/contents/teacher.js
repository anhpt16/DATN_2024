...
$(document).ready(function() {
    ...
    tbodyEl.on('click', '.view-btn', async function() {
        ...
        if (accountResponse.status === 'fulfilled') {
            teacherUI.renderInfoDetail(accountResponse.value);
        } else {
    ...
    tbodyEl.on('click', '.edit-btn', async function() {
        ...
        try {
            ...
            teacherUI.renderStatuses(statusResponse);
        } catch (error) {
    ...
    async function resetAccountDetail(accountId) {
        try {
            ...
            teacherUI.renderInfoDetail(accountResponse);
        } catch (error) {
            console.log("Error: " + error);
        }   
    }
    ...
    async function resetAccountStatuses() {
        try {
            ...
            teacherUI.renderStatuses(statuses);
        } catch (error) {
            console.log("Error: " + error);
        }
    }
